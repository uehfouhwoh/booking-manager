...
class _BookingRequestsScreenState extends State<BookingRequestsScreen> {
  ...
  String _typeFilter = 'All'; // All, Student, Staff
      ...
      body: ResponsivePageFrame(
        child: Column(
          children: [
            ...
            // Type filter — only shown to admin since students only see their own
            if (_isAdmin) ...[
              SizedBox(
                height: 40,
                child: ListView(
                  ...
                  children: ['All', 'Student', 'Staff'].map((label) {
